            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  I&apos;ve worked on a variety of projects, from simple websites to complex web applications. Some of my favorite projects were built while collaborating with teams and committees at my university, where I gained valuable
      ...
      <section id="hackathons">
        <div className="space-y-12 w-full py-12">
          <BlurFade delay={BLUR_FADE_DELAY * 13}>
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                <div className="inline-block rounded-lg bg-foreground text-background px-3 py-1 text-sm">Honors & Awards</div>
                <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl">Achievements & Hackathons</h2>
                <p className="text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Highlights from hackathons, innovation competitions, funded entrepreneurial programs, and scholarships.
                </p>
              </div>
            </div>
          </BlurFade>
